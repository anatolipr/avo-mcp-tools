...
const getEmbedSnippet: ToolDef = {
  ...
  description:
    ...
    'THIS conversation — other sessions/pages stay isolated. Share the returned snippet with the ' +
    'user and tell them to open DevTools on the target page, go to the Console tab, paste it, and ' +
    'press enter; do not construct this URL by hand.',
  schema: {},
