...
import { upsertFile, removeFile, memorySyncSpec, type TableSyncSpec } from '../store/sync.js';
...
export class MemoryRepository {
  ...
  constructor(private db: Database.Database, private defaultSourceDir: string) {
